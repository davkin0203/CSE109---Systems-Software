 ...
 * A0: These guards prevent header files from being included multiple times in a program
 * 
 ...
 * A1: The highest value was in an errno.h file and it was 133 and had the comment "Memory page has hardware error". 
 */
